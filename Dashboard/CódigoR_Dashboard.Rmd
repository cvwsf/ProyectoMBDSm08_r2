...
Column {data-width=25%}
------------------------------------------------------------------------
### Gráfico de Europa occidental por nivel relativo de motivación extrínseca
...
# Filtrar para los países de interés
europe_map_filtered <- europe_map %>%
  filter(name_long %in% country_labels)

# Fusionar los datos de motivación con el mapa
merged_data_motextr <- europe_map_filtered %>%
  left_join(country_motextr, by = c("name_long" = "cntry"))
...
Column {data-width=25%}
------------------------------------------------------------------------
### Gráfico de Europa occidental por nivel relativo de motivación intrínseca
...
# Fusionar los datos de motivación con el mapa
merged_data_motintr <- europe_map_filtered %>%
  left_join(country_motintr, by = c("name_long" = "cntry"))
...
Column {data-width=25%}
------------------------------------------------------------------------
### Gráfico de Europa occidental por nivel relativo de motivación prosocial
...
# Fusionar los datos de motivación con el mapa
merged_data_motprosoc <- europe_map_filtered %>%
  left_join(country_motprosoc, by = c("name_long" = "cntry"))
