...
# Para resolver problemas encontrados, recuperamos crear categorías de edad y convertir a factor
df_filtered <- df_filtered %>%
...
datatable(summary_country, 
          ...
          rownames = FALSE, 
          filter = 'top', 
          options = list(pageLength = 15, autoWidth = TRUE, paging = TRUE, searching = FALSE))
